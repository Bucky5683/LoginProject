...
//  LoginProject
//
//  Created by Seoyeon Kim on 2023/08/05.
//
...
final class ViewController: UIViewController {
    ...
    private lazy var emailTextFieldView: UIView = {
        ...
        // emailTextFieldView 위에 텍스트필드와 레이블을 더함
    ...
    private lazy var loginButton: UIButton = {
        ...
        button.clipsToBounds = true // 영역내로 잘라낸다
        // 선의 굵기, 색상 설정
    ...
    private lazy var stackView: UIStackView = {
        ...
        stview.spacing = 18
        stview.axis = .vertical // 축 (뷰들을 가로 또는 세로로 정렬할 때 어디를 축으로 정렬할것인가?)
        stview.distribution = .fillEqually  // 채우기
        stview.alignment = .fill // 정렬 (모두 채우기, 왼쪽/중앙/오른쪽 정렬)
        return stview
    }()
    ...
    private func configure() {
        ...
        [stackView, passwordResetButton].forEach { view.addSubview($0) } // stackView와 리셋버튼 subview로 올리기
    }
